...
/*		// launch a single client
		...
		testmyClient(cport, timeout, downloadFolder, uploadFolder);
	...
	public static void testmyClient(int cport, int timeout, File downloadFolder, File uploadFolder) {
		Client client = null;
...
//
	...
	//		}
		...
		//	try { client.load("goodbye.txt", downloadFolder); } catch(IOException e) { e.printStackTrace(); }

		//	client.send("RELOAD goodbye.txt");
